...
action_help() {
  ...
  explain_action "$R_ACTION_SEND_MSG" "发送飞书消息" "$R_TOOL_NAME $R_ACTION_SEND_MSG --app-id=<app_id> --app-secret=<app_secret> --emails=\"ji.chen@qingteng.cn\" --msg=\"{\\\"msg_type\\\":\\\"text\\\",\\\"content\\\":{\\\"text\\\":\\\"hh\\\"}}\""
}
