...
pipeline {
    ...
    environment {
        ...
        ARTFACTS_PATH = "/data/workspace/artifacts/${params.jobTag}/patrol/"
        ...
        stage('Upload') {
            steps {
                script {
                    ...
                    sh "scp patrol-srv/build/dist/${packageFile.name} $uploadUrl"
                }
            }
        }
    }
...
File findPackageFile() {
    File buildDir = new File("$WORKSPACE/patrol-srv/build/dist/")
